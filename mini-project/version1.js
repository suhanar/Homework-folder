...
let distributeAward = ()=>{
    if(soldier.hull <= 20 && soldier.hull >= 15){
        alert('Great you win a GOLD medel');
    }
    else if(soldier.hull <= 14 && soldier.hull >= 10){
        alert('Great you win a PLATINUM medel')
    }
    else if(soldier.hull <= 9 && soldier.hull >= 5){
        alert('Great you win a SILVER medel')
    }
    else if(soldier.hull <= 4 && soldier.hull >= 1){
        alert('Great you win a BRONZE medel')
    }
